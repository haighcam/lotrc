...
cdef class slice_AlignmentHelper:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = AlignmentHelper()
		val.ptr = lotrc_rs.slice_AlignmentHelper_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_AlignmentHelper_len(self.ptr)
...
cdef class LevelData:
	...
	def read_data(path):
		val = OwnedLevelData()
		val.ptr = lotrc_rs.LevelData_read_data(path)
		return val
	def version(self):
...
cdef class slice_CompressedDataRef:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		...
		val.ptr = lotrc_rs.slice_CompressedDataRef_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_CompressedDataRef_len(self.ptr)
...
cdef class LevelCompressedData:
	...
	def new():
		...
		val.ptr = lotrc_rs.LevelCompressedData_new()
		return val
	@property
	def pak(self):
...
cdef class slice_string:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = string()
		val.ptr = lotrc_rs.slice_string_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_string_len(self.ptr)
...
cdef class LevelRefPc:
	...
	def from_data(LevelData src, LevelCompressedData data):
		val = OwnedLevelRefPc()
		val.ptr = lotrc_rs.LevelRefPc_from_data(src.ptr, data.ptr)
		return val
...
cdef class LevelRefXbox:
	...
	def from_data(LevelData src, LevelCompressedData data):
		...
		val.ptr = lotrc_rs.LevelRefXbox_from_data(src.ptr, data.ptr)
		return val
	def dump(self, lotrc_rs.uint32_t compression):
		val = LevelData()
...
cdef class LevelRefPs3:
	...
	def from_data(LevelData src, LevelCompressedData data):
		...
		val.ptr = lotrc_rs.LevelRefPs3_from_data(src.ptr, data.ptr)
		return val
	def dump(self, lotrc_rs.uint32_t compression):
		val = LevelData()
...
cdef class AlignmentHelper:
	cdef lotrc_rs.AlignmentHelper* ptr
	@property
	def a(self):
		return self.ptr.a
...
cdef class slice______CompressedDataRef:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = CompressedDataRef()
		val.ptr = dereference(lotrc_rs.slice______CompressedDataRef_get(self.ptr, idx))
		return val
	def len(self):
		return lotrc_rs.slice______CompressedDataRef_len(self.ptr)
...
cdef class slice_BlockRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockRefPc()
		val.ptr = lotrc_rs.slice_BlockRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockRefPc_len(self.ptr)
...
cdef class slice_ShapeRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = ShapeRefPc()
		val.ptr = lotrc_rs.slice_ShapeRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_ShapeRefPc_len(self.ptr)
...
cdef class slice_ref_slice_u16Pc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = ref_slice_u16Pc()
		val.ptr = lotrc_rs.slice_ref_slice_u16Pc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_ref_slice_u16Pc_len(self.ptr)
...
cdef class slice_FoliageRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = FoliageRefPc()
		val.ptr = lotrc_rs.slice_FoliageRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_FoliageRefPc_len(self.ptr)
...
cdef class slice_HkShapeRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = HkShapeRefPc()
		val.ptr = lotrc_rs.slice_HkShapeRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_HkShapeRefPc_len(self.ptr)
...
cdef class slice_BlockValARefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockValARefPc()
		val.ptr = lotrc_rs.slice_BlockValARefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockValARefPc_len(self.ptr)

cdef class slice_Obj1RefPc:
	cdef lotrc_rs.slice_Obj1RefPc* ptr
	def get(self, lotrc_rs.uintptr_t idx):
		val = Obj1RefPc()
		val.ptr = lotrc_rs.slice_Obj1RefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_Obj1RefPc_len(self.ptr)
...
cdef class slice_BlockValRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockValRefPc()
		val.ptr = lotrc_rs.slice_BlockValRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockValRefPc_len(self.ptr)
...
cdef class slice_CrowdItemRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = CrowdItemRefPc()
		val.ptr = lotrc_rs.slice_CrowdItemRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_CrowdItemRefPc_len(self.ptr)
...
cdef class slice_HkConstraintBoneRefPc:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = HkConstraintBoneRefPc()
		val.ptr = lotrc_rs.slice_HkConstraintBoneRefPc_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_HkConstraintBoneRefPc_len(self.ptr)
...
cdef class slice_BlockRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockRefXbox()
		val.ptr = lotrc_rs.slice_BlockRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockRefXbox_len(self.ptr)
...
cdef class slice_ShapeRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = ShapeRefXbox()
		val.ptr = lotrc_rs.slice_ShapeRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_ShapeRefXbox_len(self.ptr)
...
cdef class slice_ref_slice_u16Xbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = ref_slice_u16Xbox()
		val.ptr = lotrc_rs.slice_ref_slice_u16Xbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_ref_slice_u16Xbox_len(self.ptr)
...
cdef class slice_FoliageRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = FoliageRefXbox()
		val.ptr = lotrc_rs.slice_FoliageRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_FoliageRefXbox_len(self.ptr)
...
cdef class slice_HkShapeRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = HkShapeRefXbox()
		val.ptr = lotrc_rs.slice_HkShapeRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_HkShapeRefXbox_len(self.ptr)
...
cdef class slice_BlockValARefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockValARefXbox()
		val.ptr = lotrc_rs.slice_BlockValARefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockValARefXbox_len(self.ptr)

cdef class slice_Obj1RefXbox:
	cdef lotrc_rs.slice_Obj1RefXbox* ptr
	def get(self, lotrc_rs.uintptr_t idx):
		val = Obj1RefXbox()
		val.ptr = lotrc_rs.slice_Obj1RefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_Obj1RefXbox_len(self.ptr)
...
cdef class slice_BlockValRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockValRefXbox()
		val.ptr = lotrc_rs.slice_BlockValRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockValRefXbox_len(self.ptr)
...
cdef class slice_CrowdItemRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = CrowdItemRefXbox()
		val.ptr = lotrc_rs.slice_CrowdItemRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_CrowdItemRefXbox_len(self.ptr)
...
cdef class slice_HkConstraintBoneRefXbox:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = HkConstraintBoneRefXbox()
		val.ptr = lotrc_rs.slice_HkConstraintBoneRefXbox_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_HkConstraintBoneRefXbox_len(self.ptr)
...
cdef class slice_BlockRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockRefPs3()
		val.ptr = lotrc_rs.slice_BlockRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockRefPs3_len(self.ptr)
...
cdef class slice_ShapeRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = ShapeRefPs3()
		val.ptr = lotrc_rs.slice_ShapeRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_ShapeRefPs3_len(self.ptr)
...
cdef class slice_ref_slice_u16Ps3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = ref_slice_u16Ps3()
		val.ptr = lotrc_rs.slice_ref_slice_u16Ps3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_ref_slice_u16Ps3_len(self.ptr)
...
cdef class slice_FoliageRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = FoliageRefPs3()
		val.ptr = lotrc_rs.slice_FoliageRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_FoliageRefPs3_len(self.ptr)
...
cdef class slice_HkShapeRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = HkShapeRefPs3()
		val.ptr = lotrc_rs.slice_HkShapeRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_HkShapeRefPs3_len(self.ptr)
...
cdef class slice_BlockValARefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockValARefPs3()
		val.ptr = lotrc_rs.slice_BlockValARefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockValARefPs3_len(self.ptr)

cdef class slice_Obj1RefPs3:
	cdef lotrc_rs.slice_Obj1RefPs3* ptr
	def get(self, lotrc_rs.uintptr_t idx):
		val = Obj1RefPs3()
		val.ptr = lotrc_rs.slice_Obj1RefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_Obj1RefPs3_len(self.ptr)
...
cdef class slice_BlockValRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = BlockValRefPs3()
		val.ptr = lotrc_rs.slice_BlockValRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_BlockValRefPs3_len(self.ptr)
...
cdef class slice_CrowdItemRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = CrowdItemRefPs3()
		val.ptr = lotrc_rs.slice_CrowdItemRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_CrowdItemRefPs3_len(self.ptr)
...
cdef class slice_HkConstraintBoneRefPs3:
	...
	def get(self, lotrc_rs.uintptr_t idx):
		val = HkConstraintBoneRefPs3()
		val.ptr = lotrc_rs.slice_HkConstraintBoneRefPs3_get(self.ptr, idx)
		return val
	def len(self):
		return lotrc_rs.slice_HkConstraintBoneRefPs3_len(self.ptr)
